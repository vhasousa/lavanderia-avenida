    ...
    <PriceContainer>
      ...
      <div className="price__cards">
        <article className="cards">
          <div>
            <img src={calendar} alt="" className="cards__image" />
            <h3>Mensal</h3>
          </div>
          <p>
        ...
        <article className="cards">
          <div>
            <img src={weight} alt="" className="cards__image" />
            <h3>Por quilo</h3>
          </div>
          <p>
        ...
        <article className="cards">
          <div>
            <img src={peace} alt="" className="cards__image" />
            <h3>Por peça</h3>
          </div>
          <a href="#">
            <p>Ver tabela</p>
        ...
        <article className="cards">
          <div>
            <img src={hotel} alt="" className="cards__image" />
            <h3>Hotelaria</h3>
          </div>
